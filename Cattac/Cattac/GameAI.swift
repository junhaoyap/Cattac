...
class GameAI {
    ...
    ///
    /// - parameter grid: The game level grid.
    /// - parameter gameManager: The game engine.
    /// - parameter currentPlayer: The Cat object of the current player.
    ...
    /// positions.
    func calculateTurn() {
        for (_, player) in gameEngine.gameManager.aiPlayers {
